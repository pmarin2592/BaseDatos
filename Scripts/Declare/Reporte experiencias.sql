...
DECLARE
    ...
    V_EXPERIENCETYPE                  VARCHAR (100);
    V_COUNT_APPLICANT              NUMBER;  
    
BEGIN
    -- Llamada al procedimiento que abre el cursor
    UTIL_EXPERIENCETYPES_PKG.REPORT_EXPERIENCETYPES_PR (P_CURSOR   => CURSOR_VAR,
                                              P_ERROR    => ERROR_VAR);
    ...
    LOOP
        ...
        DBMS_OUTPUT.PUT_LINE ('EXPERIENCETYPE: ' || V_EXPERIENCETYPE);
